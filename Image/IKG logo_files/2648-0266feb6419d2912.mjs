"use strict";(self.__LOADABLE_LOADED_CHUNKS__=self.__LOADABLE_LOADED_CHUNKS__||[]).push([[2648,89870],{612435:(e,t,i)=>{i.d(t,{Z:()=>a});var n=i(667294),s=i(614792),o=i(785893);function a({page:e,children:t}){let i=(0,n.useMemo)(()=>({logging:{viewType:"login"===e&&9||"businessLogin"===e&&267||void 0},pageType:e}),[e]);return(0,o.jsx)(n.Fragment,{children:(0,o.jsx)(s.Mi,{value:i,children:t})})}},420097:(e,t,i)=>{i.d(t,{Z:()=>C});var n=i(667294),s=i(545007),o=i(214877),a=i(658583),r=i(622541),l=i(353971),c=i(175324),h=i(239493),d=i(322079),u=i(614792),g=i(976731),p=i(140017),m=i(96452),b=i(640258),f=i(897650),_=i(974371),x=i(602377),w=i(508218),v=i(516256),y=i(237856),j=i(340523),P=i(306775),S=i(5859),A=i(217058),E=i(623409),T=i(472980),I=i(149722),O=i(785893);function Z(e,t,i){var n;return(t="symbol"==typeof(n=function(e,t){if("object"!=typeof e||null===e)return e;var i=e[Symbol.toPrimitive];if(void 0!==i){var n=i.call(e,t||"default");if("object"!=typeof n)return n;throw TypeError("@@toPrimitive must return a primitive value.")}return("string"===t?String:Number)(e)}(t,"string"))?n:String(n))in e?Object.defineProperty(e,t,{value:i,enumerable:!0,configurable:!0,writable:!0}):e[t]=i,e}class k extends n.Component{constructor(...e){super(...e),Z(this,"state",{modal:null}),Z(this,"annotateOneTapStopwatch",e=>(0,P.M3)("google_autologin",e)),Z(this,"abortOneTapStopwatch",e=>(0,P.RP)("google_autologin",e)),Z(this,"stopOneTapStopwatch",()=>(0,P.PA)("google_autologin")),Z(this,"trackAutologin",e=>(0,A.dy)({event:e,provider:"google"})),Z(this,"deferredHandleOneTapResponse",e=>{setTimeout(()=>{this.handleOneTapResponse(e)},5e3)}),Z(this,"handleOneTapResponse",e=>{let{autologinDisabled:t,login:i,viewer:n}=this.props;if(!e)return;let{credential:s,select_by:o}=e,a=(0,f.PL)(o),r="AUTO_LOGIN"===a;if(this.annotateOneTapStopwatch("autoLoginGoogleEnd"),this.stopOneTapStopwatch(),r&&t)return;r&&this.trackAutologin("pinterest_login_start");let{pageContext:l}=this.props;i({creds:{google_open_id_token:s,autologin:r},loggingOptions:{loggingData:{container:"google_one_tap_modal",page:l?.pageType,trigger:(0,f.mK)(a)},loginAttemptContextEvent:{event_type:7534,element:"SIGN_IN_WITH_GOOGLE_BUTTON"===a?12981:"ONE_TAP_PROMPT"===a?12982:null,aux_data:{signup_login_method:v.Z.GOOGLE_ONE_TAP,upsell_reason:r?"autologin_google":"google_one_tap",...n.isAuth?{login_state:n.isLimitedLogin?x.Z.LIMITED:x.Z.DEFAULT}:{}}}}}).then(()=>{let{nextUrl:e}=this.props;r&&this.trackAutologin("pinterest_login_success"),e?w.ZP.handleRedirect(e):w.ZP.handleRedirectWithFallbackWindowLocation(),r&&this.trackAutologin("end")},e=>{let{hide:t,handleLoginWithMfa:i}=this.props;r&&this.trackAutologin("pinterest_login_failure");let n=(0,g.Z)(e,"api_error_code");if(n===m.xN){if("SIGN_IN_WITH_GOOGLE_BUTTON"===a)this.attemptSignup({googleOpenId:s});else{let e="business_login_page"===this.props.container;this.setState({modal:{type:"confirmSignup",step:e?r&&"staticSignupLogin"||"delayedSignupLoadingSpinner":"staticSignupLoginWithTOS",handleConfirmSignup:()=>this.attemptSignup({googleOpenId:s})}})}}else if(n===m.Zn)i(s);else if(n===m.an)this.setState({modal:{type:"accountSuspended"}});else{let e=this.props.i18n._('We couldn\u2019t log you in with that account. Try the Google button!', ' - ', ' -- ');(0,h.x)(e),t()}r&&this.trackAutologin("end")})}),Z(this,"attemptSignup",({googleOpenId:e})=>{let{handleGdprRequiresAge:t,pageContext:i}=this.props,n=(0,b.Z)(e);t({options:{type:"google",google_open_id_token:e,first_name:n.given_name,last_name:n.family_name,image_url:n.picture},context:{container:"google_one_tap_modal",page:i?.pageType}}),(0,A.NC)("check_age_with_one_tap_from_one_tap_dweb")})}componentDidMount(){let{requestContext:e,webGoogleDisabled:t}=this.props;a.U2(r.e7)&&(0,A.My)(`pcons.google_autologin_disabled_cookie.login_page.${(0,y.M)()}`),t||a.U2(r.e7)&&e.isBot?this.abortOneTapStopwatch("disabled"):(this.setupGoogleOneTap(),e.isBot||(0,A.My)("unauth_web_container.google_one_tap_modal.tier1.other.shown"))}async setupGoogleOneTap(){let{googleSignInApi:e}=this.props;await e?.ensureInit("oneTap",this.deferredHandleOneTapResponse),this.trackAutologin("show_ui"),f.Fm()?.prompt(()=>{})}render(){let{requestContext:e,webGoogleDisabled:t,hide:i}=this.props,{modal:n}=this.state;if(e.isBot||t||!n)return null;switch(n.type){case"accountSuspended":return(0,O.jsx)(l.Z,{onClose:()=>this.setState({modal:null})});case"confirmSignup":return(0,O.jsx)(c.Z,{handleCancelClick:()=>this.setState({modal:null}),handleConfirmSignup:n.handleConfirmSignup,handleShowLogin:i,step:n.step});default:return null}}}function C({container:e,handleGdprRequiresAge:t,handleLoginWithMfa:i,nextUrl:a}){let r=(0,d.Z)(),{logContextEvent:l}=(0,o.v)(),c=(0,p.ZP)(),h=(0,s.I0)(),g=(0,I.Z)(),[m,b]=(0,n.useState)(!0),{checkExperiment:f}=(0,j.F)(),{anyEnabled:x}=f("web_google_disabled"),w=(0,S.B)(),v=(0,u.lO)(),{country:y}=w,P=(0,_.M)(),A=(0,T.Z)(),Z=(0,E.Z)();if(!m||A)return null;let C=()=>b(!1);return(0,O.jsx)(k,{autologinDisabled:"CH"===y,checkExperiment:f,container:e,dispatch:h,googleSignInApi:P,handleEmptyCredentials:C,handleGdprRequiresAge:e=>{C(),t(e)},handleLoginWithMfa:e=>{C(),i(e)},hide:C,i18n:c,logContextEvent:l,login:r,nextUrl:a,pageContext:v,requestContext:w,trackInteraction:Z,viewer:g,webGoogleDisabled:x})}},473289:(e,t,i)=>{i.d(t,{Z:()=>I});var n=i(667294),s=i(616550),o=i(883119),a=i(612435),r=i(420097),l=i(29156),c=i(549629),h=i(106110),d=i(999586),u=i(876569),g=i(273523),p=i(454514),m=i(140017),b=i(406893),f=i(739670),_=i(486587),x=i(5859),w=i(702497),v=i(13848),y=i(624797),j=i(598228),P=i(531486),S=i(678379),A=i(785893);let E=`${j.C0}${w.Hm8}`,T=()=>g.Z+d.Z;function I({redirectToBusinessForSignup:e,isForLimitedLogin:t,attributionLabel:i}){(0,c.Q)({view_type:9});let d=(0,m.ZP)(),g=(0,s.TH)(),w=(0,y.mB)(g.search),j=(0,v.F9)(),[I,O]=(0,n.useState)({type:"login"}),[Z,k]=(0,n.useState)(!1),{isMobile:C}=(0,x.B)().userAgent,z=w.next&&(0,P.Z)(w.next)?w.next:"/",D=t||"true"!==w.board_invite?"login":"boardInvite",L=e=>{e&&j.showOneToast(({hideToast:t})=>(0,A.jsx)(p.ZP,{duration:f.Jl,onHide:t,text:e}))};(0,n.useEffect)(()=>{L((0,_.Z)(d,g))},[]);let M="signup"===I.type;return(0,n.useEffect)(()=>{e&&M&&(0,l.Z)(E,!1)},[e,M]),(0,A.jsx)(a.Z,{page:"login",children:(0,A.jsxs)(o.xu,{height:"100%",position:"absolute",top:!0,width:"100%",children:[(0,A.jsx)(o.xu,{bottom:!0,dangerouslySetInlineStyle:{__style:{overflowY:"hidden"}},left:!0,position:"absolute",right:!0,top:!0,children:(0,A.jsx)(S.default,{})}),(0,A.jsx)(o.xu,{bottom:!0,dangerouslySetInlineStyle:{__style:{background:"rgba(0, 0, 0, .5)"}},left:!0,position:"fixed",right:!0,top:!0}),Z?(0,A.jsx)(u.Z,{}):(0,A.jsxs)(n.Fragment,{children:[(0,A.jsxs)(o.xu,{dangerouslySetInlineStyle:{__style:{left:"50%",top:"50%",transform:"translate(-50%, -50%)"}},position:"absolute",children:[(0,A.jsx)(b.Z,{unsafeCSS:T()}),(0,A.jsx)(h.default,{attributionLabel:i,container:"login_page",handleShowingSignupWelcomeLoading:e=>{e!==Z&&k(e)},nextUrlParam:z,signupFlow:I,signupRedirectUrl:e?E:"",signupSource:D,toggleType:"SMALL_TOGGLE"})]}),!C&&(0,A.jsx)(o.xu,{"data-test-id":"login"===I.type?"simple-signup-button":"simple-login-button",left:!0,marginStart:6,marginTop:12,position:"absolute",top:!0,children:(0,A.jsx)(o.zx,{color:"white",fullWidth:!0,onClick:()=>{O("login"===I.type?{type:"signup"}:{type:"login"})},text:"login"===I.type?d._('Sign up', 'sign up for account toggle on homepage', 'sign up for account toggle on homepage'):d._('Log in', 'Label for log in button', 'Label for log in button')})}),(0,A.jsx)(r.Z,{container:"login_page",handleGdprRequiresAge:({options:e,context:t})=>{O({type:"socialSignupWithAge",registrationCredentials:{type:"google_one_tap",context:t,signupOptions:e}})},handleLoginWithMfa:e=>{O({type:"loginMfa",creds:{google_open_id_token:e}})},nextUrl:z})]})]})})}},214274:(e,t,i)=>{i.d(t,{Z:()=>n});let n='-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Oxygen-Sans,Ubuntu,Cantarell,"Fira Sans","Droid Sans","Helvetica Neue",Helvetica,"Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol","ヒラギノ角ゴ Pro W3","Hiragino Kaku Gothic Pro",メイリオ,Meiryo,"ＭＳ Ｐゴシック",Arial,sans-serif'},378720:(e,t,i)=>{i.d(t,{Z:()=>s});var n=i(667294);let s=()=>{let[e,t]=(0,n.useState)(!1);return(0,n.useEffect)(()=>{t(!0)},[]),e}},175324:(e,t,i)=>{i.d(t,{Z:()=>g});var n=i(667294),s=i(883119),o=i(587703),a=i(140017),r=i(494125),l=i(785893);function c({handleSignup:e,handleLogin:t}){let i=(0,a.ZP)(),[o,c]=(0,n.useState)(!1),h=(0,n.useRef)(null);return(0,r.Z)(()=>{let t;return h.current=window.setTimeout(()=>{t=window.requestAnimationFrame(()=>{c(!0)}),e()},2e3),()=>{h.current&&window.clearTimeout(h.current),t&&window.cancelAnimationFrame(t)}}),(0,l.jsxs)(s.kC,{alignItems:"center",direction:"column",flex:"grow",justifyContent:"center",children:[(0,l.jsx)(s.xu,{children:(0,l.jsx)(s.xv,{align:"center",size:"400",weight:"bold",children:o?i._('Finishing up...', 'Title of a dialog telling the user that an account is almost done being created.', 'Title of a dialog telling the user that an account is almost done being created.'):i._('Creating your account...', 'Title of a dialog telling the user that an account is being created.', 'Title of a dialog telling the user that an account is being created.')})}),(0,l.jsx)(s.xu,{paddingY:4,children:(0,l.jsx)(s.$j,{accessibilityLabel:i._('Account is being created', 'Accessibility label for account creation loading dialog', 'Accessibility label for account creation loading dialog'),show:!0})}),o?null:(0,l.jsx)(s.xu,{marginTop:2,children:(0,l.jsx)(s.xv,{align:"center",inline:!0,children:i._('Didn\u2019t mean to create a new account?', 'Description text telling the user that they can log in if they did not intend to create a new account', 'Description text telling the user that they can log in if they did not intend to create a new account')})}),o?null:(0,l.jsx)(s.xu,{children:(0,l.jsx)(s.xv,{align:"center",inline:!0,children:(0,l.jsx)(s.rU,{display:"inlineBlock",href:"/login",onClick:({event:e,dangerouslyDisableOnNavigation:i})=>{i(),h.current&&window.clearTimeout(h.current),e&&(e.preventDefault(),e.stopPropagation()),t()},underline:"hover",children:i._('Click here to log in.', 'Login button which will show the login modal and enable the user to log in', 'Login button which will show the login modal and enable the user to log in')})})})]})}var h=i(120726),d=i(610954);let u=({children:e})=>(0,l.jsx)(s.xu,{bottom:!0,dangerouslySetInlineStyle:{__style:{backgroundColor:"rgba(0, 0, 0, 0.6)"}},left:!0,opacity:1,position:"fixed",right:!0,top:!0,zIndex:new s.Ry(1e3),children:(0,l.jsx)(s.xu,{color:"default",direction:"column",display:"flex",margin:6,padding:7,position:"fixed",right:!0,rounding:2,top:!0,width:376,children:e})});function g({handleCancelClick:e,handleConfirmSignup:t,handleShowLogin:i,step:g}){let p=(0,a.ZP)(),[m,b]=(0,n.useState)(!1),f=(0,o.Z)(),_={view_type:10,view_parameter:3202};(0,r.Z)(()=>(f({event_type:120,view_parameter:_.view_parameter}),document.body&&(document.body.style.overflow="hidden"),()=>{document.body&&(document.body.style.overflow="")}));let x=()=>{f({..._,event_type:101,element:30}),i()};return(0,l.jsx)(u,{children:"delayedSignupLoadingSpinner"===g?(0,l.jsx)(c,{handleLogin:x,handleSignup:()=>{f({..._,event_type:101,element:31}),t()}}):(0,l.jsxs)(s.xu,{children:[m?(0,l.jsx)(d.Z,{}):null,(0,l.jsx)(s.xu,{display:"inlineBlock",marginEnd:2,marginTop:2,position:"absolute",right:!0,top:!0,children:(0,l.jsx)(s.hU,{accessibilityLabel:p._('Cancel', 'Button to close the signup/login modal', 'Button to close the signup/login modal'),icon:"cancel",iconColor:"gray",onClick:()=>{f({..._,event_type:101,element:73}),e()},size:"sm"})}),(0,l.jsx)(s.xv,{align:"start",size:"400",weight:"bold",children:p._('Continue to Pinterest', 'Title of a dialog telling enabling the user to continue with sign up or log in', 'Title of a dialog telling enabling the user to continue with sign up or log in')}),(0,l.jsx)(s.xu,{marginTop:2,children:(0,l.jsx)(s.xv,{align:"start",children:p._('Hmm, it looks like you don\'t have an account yet. Let\'s get started!', 'Description text of a dialog asking the user to sign up for a Pinterest account', 'Description text of a dialog asking the user to sign up for a Pinterest account')})}),(0,l.jsx)(s.xu,{marginTop:5,children:(0,l.jsx)(s.zx,{color:"red",fullWidth:!0,onClick:()=>{f({..._,event_type:101,element:31}),b(!0),t()},text:p._('Sign up', 'Text on a button which will create an account when clicked', 'Text on a button which will create an account when clicked')})}),(0,l.jsx)(s.xu,{marginTop:2,children:(0,l.jsx)(s.zx,{color:"gray",fullWidth:!0,onClick:x,text:p._('Log in using a different method', 'Text on a button which will take the user to login when clicked.', 'Text on a button which will take the user to login when clicked.')})}),"staticSignupLoginWithTOS"===g?(0,l.jsx)(s.xu,{marginEnd:4,marginStart:4,marginTop:4,children:(0,l.jsx)(h.Z,{})}):null]})})}},999586:(e,t,i)=>{i.d(t,{Z:()=>n});let n=`
